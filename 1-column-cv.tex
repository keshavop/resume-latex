...
\begin{center}
    ...
    \small \href{phone:7857982609}{ \raisebox{-0.1\height}\faPhone\ \underline{7857982609} ~} \href{mailto:keshavkumar8122@gmail.com}{\raisebox{-0.2\height}\faEnvelope\  \underline{keshavkumar8122@gmail.com}} ~ 
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Contributed to the development of \textbf{Loan against Mutual Funds} (\textbf{LAMF}) project, gaining valuable experience in lending and mutual funds.}
        \resumeItem{Implemented key metrics and \textbf{Grafana} dashboards for monitoring investment services, enabling \textbf{Prometheus}-based alert system for proactive issue identification, enhancing service reliability by 15\%.}
        \resumeItem{Created \textbf{OneView} internal dashboard for \textbf{Spend Linked} and \textbf{LAMF} to streamline handling of customer support tickets, boosting customer satisfaction.}
      \resumeItemListEnd 
  \resumeSubHeadingListEnd
...
\section{Projects}
    ...
    \resumeProjectHeading 
        ...
        \vspace{1pt}
          ...
          \vspace{1pt}
          \resumeItem{Implemented \textbf{Codemirror} to create modern UI IDE, integrated \textbf{Rapid API} to compile and execute code in popular languages, including C, C++, JAVA, JavaScript, etc. }
          \vspace{1pt}
        \resumeItemListEnd
        \vspace{-16pt}
...
$\sbullet[.75] \hspace{0.2cm}${{Contributed to \textit{Hacktoberfest} in 2021 and 2022}} {\href{https://drive.google.com/file/d/11qa8d9tDFXLJiDeccjvG6gAMsaZidgY7/view?usp=sharing}{\raisebox{-0.1\height}\faExternalLink }}
\hspace{2cm}\\

$\sbullet[.75] \hspace{0.2cm}${{Participate in \textit{Google Cloud Facilitator Program} \& \textit{Google Cloud Ready Program}}} {\href{https://www.cloudskillsboost.google/public_profiles/792a8b6a-c5e8-4b7f-a4b4-6245803d471c}{\raisebox{-0.1\height}\faExternalLink }}
\hspace{2cm}\\
